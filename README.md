...
function = proj.new_function("donwload_images",kind="container",image="alattaruolo/sentinel-basic:v0.0.17",command="python",args=list_args)
 ```
...
sudo docker tag main-python alattaruolo/sentinel-basic:v0.0.18
sudo docker push alattaruolo/sentinel-basic:v0.0.18
```
